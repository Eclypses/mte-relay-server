...
export async function encodeRequest(
  ...
  delete newHeaders[SETTINGS.OUTBOUND_TOKEN_HEADER];
  delete newHeaders[SETTINGS.OUTBOUND_UPSTREAM_HEADER];
  delete newHeaders[SETTINGS.OUTBOUND_ENCODE_TYPE_HEADER];
  delete newHeaders[SETTINGS.OUTBOUND_ENCODE_HEADERS_HEADER];
  delete newHeaders[SETTINGS.OUTBOUND_ENCODE_URL_HEADER];
