...
- `debug`
  ...
  - Default: `false`
- `logLevel`
  - The level of logging the application should provide; fatal, error, warn, info, debug, trace, silent
  - Default `info`
- `passThroughRoutes`
...
- `maxPoolSize`
  ...
  - Default: `25`
- `secret`
  - A server-side secret that is required to be known on both ends of the connection to establish a functional encoder/decoder pair. This is primarily used in server-to-server communication.
...
secret: ykgw4QLEtqNRV37dbp2BuJCmT
```
